function AppViewModel(dataModel) {
    ...
    self.addViewModel = function (options) {
        ...
        // Add navigation member to AppViewModel (for example, app.navigateToLocal());
    ...
    self.onDeviceReady = function () {
        ...
        iabRef.addEventListener('loadstart', function () { alert(event.url); });
    };
                ...
                .done(function(data) {
                    if (typeof(data.userName) !== "undefined" && typeof(data.hasRegistered) !== "undefined"
                        ...
                        if (data.hasRegistered) {
                            ...
                            self.registerExternal(data.userName, data.loginProvider, fragment.access_token,
    ...
    self.registerExternal = function(userName, loginProvider, externalAccessToken, loginUrl, state) {

        app.errors.removeAll();

        dataModel.registerExternal(externalAccessToken, {
            userName: userName
        }).done(function(data) {
